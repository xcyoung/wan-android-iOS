...
open class PageControl: UIControl {
    ...
    @IBInspectable
    @objc dynamic open var numberOfPages: Int = 0 {
        didSet {
    ...
    @IBInspectable
    @objc dynamic open var currentPage: Int = 0 {
        didSet {
    ...
    @IBInspectable
    @objc dynamic open var itemSpacing: CGFloat = 6 {
        didSet {
            self.setNeedsUpdateIndicators()
        }
    }
    ...
    @IBInspectable
    @objc dynamic open var interitemSpacing: CGFloat = 6 {
        didSet {
            self.setNeedsLayout()
        }
    }
    ...
    @objc dynamic open var contentInsets: UIEdgeInsets = UIEdgeInsets(top: 0.0, left: 0.0, bottom: 0.0, right: 0.0) {
        didSet {
            self.setNeedsLayout()
        }
    }
    ...
    @objc dynamic open override var contentHorizontalAlignment: UIControl.ContentHorizontalAlignment {
        didSet {
            self.setNeedsLayout()
        }
    }
    ...
    @objc dynamic fileprivate weak var contentView: UIView!
    
    @objc dynamic fileprivate var needsUpdateIndicators = false
    @objc dynamic fileprivate var needsCreateIndicators = false
    @objc dynamic fileprivate var indicatorLayers = [CAShapeLayer]()
    
    @objc dynamic fileprivate var runLoopObserver: CFRunLoopObserver?
    @objc dynamic fileprivate var runLoopCallback: CFRunLoopObserverCallBack = {
    ...
    @objc dynamic public override init(frame: CGRect) {
        super.init(frame: frame)
        commonInit()
    }
    
    @objc dynamic public required init?(coder aDecoder: NSCoder) {
    ...
    @objc dynamic open override func layoutSubviews() {
    ...
    @objc dynamic open override func layoutSublayers(of layer: CALayer) {
    ...
    @objc dynamic fileprivate func commonInit() {
    ...
    @objc dynamic fileprivate func setNeedsUpdateIndicators() {
        self.needsUpdateIndicators = true
        self.setNeedsLayout()
    }
    
    @objc dynamic fileprivate func updateIndicatorsIfNecessary() {
    ...
    @objc dynamic fileprivate func updateIndicatorAttributes(for layer: CAShapeLayer) {
    ...
    @objc dynamic fileprivate func setNeedsCreateIndicators() {
        self.needsCreateIndicators = true
    }
    
    @objc dynamic fileprivate func createIndicatorsIfNecessary() {
